...
# 598 "c:\\mingw\\include\\stdlib.h" 3
...
# 624 "c:\\mingw\\include\\stdlib.h" 3
...
# 707 "c:\\mingw\\include\\stdlib.h" 3
...
# 728 "c:\\mingw\\include\\stdlib.h" 3
__attribute__((__cdecl__)) __attribute__((__nothrow__)) void _Exit(int) __attribute__((__noreturn__));
...
# 749 "c:\\mingw\\include\\stdlib.h" 3
__attribute__((__cdecl__)) __attribute__((__nothrow__))
...
# 805 "c:\\mingw\\include\\stdlib.h" 3
...
# 845 "c:\\mingw\\include\\stdlib.h" 3
...
# 887 "c:\\mingw\\include\\stdlib.h" 3
extern inline __attribute__((__gnu_inline__)) __attribute__((__always_inline__))
...
# 898 "c:\\mingw\\include\\stdlib.h" 3
...
void delIndexElement(Element **beginList)
{
 ...
 else
 {
  ...
  while(index != count+2)
  {
   if(index <= 0 || temp->nextPtr->nextPtr == 
# 152 "LinkedList.c" 3 4
                                             ((void *)0)
# 152 "LinkedList.c"
                                                 )
   {
